...
def generate_prank_output(target_dir, source_dir, name_map, datatype, output_options=[], output_format="fasta", file_prefix=None):
	...
	if not isinstance(name_map, dict):
        ...
        #default
        origin_align_path = os.path.join(source_dir, prefix+middle+align_file_suffix)
        result_align_path = os.path.join(target_dir, "%s.%s"%(file_prefix, align_file_suffix))
        out_anc = False
